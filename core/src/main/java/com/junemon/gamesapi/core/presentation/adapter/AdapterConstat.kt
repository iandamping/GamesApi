package com.junemon.gamesapi.core.presentation.adapter
...
object AdapterConstant {
    ...
    val listDeveloperAdapterCallback = object : DiffUtil.ItemCallback<DeveloperData>() {
        override fun areItemsTheSame(oldItem: DeveloperData, newItem: DeveloperData): Boolean =
            oldItem.id == newItem.id

        override fun areContentsTheSame(oldItem: DeveloperData, newItem: DeveloperData): Boolean =
            oldItem == newItem
    }
}